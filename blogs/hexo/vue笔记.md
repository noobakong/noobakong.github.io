---
title: Vue-笔记
date: 2018-08-04 15:37:46
tags:
 - vue
categories:
 - Vue
---
> 最近跟着慕课网老师在做一个vue-travel去哪网基础vue课程，记录下的学习笔记。
...
```
![生命周期钩子执行](https://blog-1257919906.cos.ap-guangzhou.myqcloud.com/image/notes/%E7%94%9F%E5%91%BD%E5%91%A8%E6%9C%9F%E9%92%A9%E5%AD%90%E6%89%A7%E8%A1%8C.png)
...
![](https://blog-1257919906.cos.ap-guangzhou.myqcloud.com/image/notes/vue-%E5%8A%A8%E7%94%BB%E5%8E%9F%E7%90%86.png)



**离开动画的过程图**

![](https://blog-1257919906.cos.ap-guangzhou.myqcloud.com/image/notes/vue-%E5%8A%A8%E7%94%BB%E5%8E%9F%E7%90%862.png)
...
**输出结果：**
![](https://blog-1257919906.cos.ap-guangzhou.myqcloud.com/image/notes/vue-%E5%8A%A8%E7%94%BBjs%E9%92%A9%E5%AD%90.jpg)
...
- Status 存放的是共用 的数据
- Actions 组件修改数据调用Actions进行异步处理或者批量操作
- 最后通过Mutations才能将值修改成功

> 有的时候也可以略过actions 直接调用Mutations来修改数据 

### 使用vuex

**使用vuex 先安装 再用创代码建上图绿框中的一个系统**
...
**具体使用**
1. 把要公用的数据（例如city）定义到store/index.js的state中，在页面中把有city的地方换成 
```js
`{{this.$store.state.city}}`
```
